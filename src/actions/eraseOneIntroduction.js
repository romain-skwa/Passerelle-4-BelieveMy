...
const deleteIntroduction = async (gameId, nameOfGame) => {
  // Get user session
    ...
    try {
      const { data, error } = await resend.emails.send({
        ...
        html: `<p style="text-align: center;">This is my game.com</p>
              <p><u>${decodedUsername}</u>, nous vous confirmons que la présentation du jeu : <b>${nameOfGame}</b> a bien été effacée.</p>
