...
export default function Share({ currentUrl }) {
  ...
  useEffect(() => {
    ...
    if (currentUrl) {
      // Placer currentUrl AVANT le reste pour que l'encadré youtube s'affiche.
  ...
  return (
    <div>
      <p className="flex justify-center text-sm my-2">
        {language === "fr" ? "Partagez cette page :" : "Share : "}
      </p>
