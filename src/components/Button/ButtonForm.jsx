...
export default function ButtonForm({ children,formButton }) {
  ...
  return (
    ...
    <button
      ...
      className="text-white bg-black/70 border-2 p-3 mx-auto min-w-48 rounded-full m-2 disabled:bg-opacity-50 disabled:cursor-not-allowed hover:bg-white hover:transition hover:duration-300 hover:text-black"
    >
      {children}
    </button>
  );
